...
数据模板支持 [handlebars 模板语法](http://handlebarsjs.com/) ，支持的变量（使用两个大括号包起来 <code ng-non-bindable></code>）包括：
...
<div class="wrap">
  ...
  <div class="section section-download" >
    <div class="section-inner">
      <p>或者下载应用:</p>
      <div >
        <p><a href=''>iPhone 应用</a></p>
        <p><a href=''>iPad 应用</a></p>
        <p><a href=''>Android 手机应用</a></p>
        <p><a href=''>Android 平板应用</a></p>
    </div>
  </div>
</div>
```
